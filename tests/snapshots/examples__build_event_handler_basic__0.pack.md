...
`@function event_handler_basic:reapermc/crankshaft/event_handler/user_defined/handler/on_player_mainhand_empty/0`

```mcfunction
execute unless data entity @s SelectedItem run function #event_handler_basic:reapermc/crankshaft/event_handler/user_defined/endpoint/on_player_mainhand_empty
```

`@function event_handler_basic:reapermc/crankshaft/event_handler/user_defined/payload/on_player_mainhand_empty/0`

```mcfunction
say hi!
```

`@function_tag event_handler_basic:reapermc/crankshaft/event_handler/user_defined/endpoint/on_player_mainhand_empty`

```json
{
  "replace": false,
  "values": [
    "event_handler_basic:reapermc/crankshaft/event_handler/user_defined/payload/on_player_mainhand_empty/0"
  ]
}
```
